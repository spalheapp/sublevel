...
function bloquearSource(e) {
     ...
     <link rel="shortcut icon" href="https://sublevel.vercel.app/img/favicon.png">
		...
		<link rel="stylesheet" href="assets/css/tipped.css">
          ...
          *::-webkit-scrollbar-thumb {
            background-image: linear-gradient(180deg, #6EC2B1 0%, #FFF2E1 99%);
            border-radius: 10px;
	...
	<body>
		...
		<section id="helpme">
			<div class="helpme">
				<header>
					<a class="linkBackControl" href="https://sublevel.vercel.app/">
				...
				<?php 
				$i = 0;
				$json = json_decode(file_get_contents('https://sublevel.vercel.app/faq/suporte.json'));
